...
/*
 * HighScoreScreen component displays the current high scores of the game. It receives an array of player stats objects
 ...
 */
function HighScoreScreen({currHighscores}) {
